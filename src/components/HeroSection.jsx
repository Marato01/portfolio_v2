...
export const HeroSection = () => {
  return (
    <section
      className="relative min-h-screen flex flex-col items-center justify-center px-4 bg-gradient-to-b from-secondary/10 to-transparent"
    >
      <style>{`
        @keyframes fade-in {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex justify-center md:justify-end">
            <img
              ...
              className="w-64 h-64 md:w-80 md:h-80 rounded-full border-4 border-primary/20 dark:border-primary/40 shadow-lg opacity-0 animate-fade-in-delay-5 object-cover"
              onError={(e) => {
